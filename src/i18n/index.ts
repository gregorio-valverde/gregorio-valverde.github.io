...
export const ui = {
  en: {
    ...
    publications: {
      ...
      description: 'Technical decisions, articles and short notes about data engineering, analytics and architecture.',
      heading: 'Publications',
      intro: 'Technical decisions, deeper articles and short notes. Filter the content depending on what you want to explore.',
      all: 'All', decision: 'Decisions', article: 'Articles', note: 'Notes',
      read: 'Read publication', empty: 'No publications match this filter.', demo: 'Sample content',
      types: { decision: 'Decision', article: 'Article', note: 'Note' },
    },
    journey: {
    ...
    contact: {
      ...
      description: 'Get in touch to discuss data engineering, business intelligence, analytics, digital transformation, or professional opportunities.',
      heading: "Let's Talk",
  ...
  es: {
    ...
    publications: {
      ...
      description: 'Decisiones técnicas, artículos y notas sobre ingeniería de datos, analítica y arquitectura.',
      heading: 'Publicaciones',
      intro: 'Decisiones técnicas, artículos más desarrollados y notas breves. Puedes filtrar el contenido según lo que quieras explorar.',
      all: 'Todas', decision: 'Decisiones', article: 'Artículos', note: 'Notas',
      read: 'Leer publicación', empty: 'No hay publicaciones para este filtro.', demo: 'Contenido de ejemplo',
      types: { decision: 'Decisión', article: 'Artículo', note: 'Nota' },
    },
    journey: {
    ...
    contact: {
      title: 'Contacto',
      description: 'Contacta conmigo para hablar sobre Data Engineering, Business Intelligence, Analytics, Transformación Digital u oportunidades profesionales.',
      heading: 'Hablemos',
